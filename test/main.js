...
import { generalMocks, newService } from "anura-data-manager/lib/tests/mocks"
...
describe("FileSystem data manager ", function () {
    describe("check requests", function () {
        beforeEach(function () {
            ...
            this.dataManager = new FileSystemManager({
                config: { STORE_LOCATION: this.filePath }
                , log: generalMocks.logMock
            })
